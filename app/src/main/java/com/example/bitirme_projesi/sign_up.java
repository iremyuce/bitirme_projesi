                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            if (currentUser != null) {
                                ...
                                Toast.makeText(sign_up.this, "Kayıt Başarılı", Toast.LENGTH_LONG).show();
                            }
                            Intent i= new Intent(sign_up.this, MainActivity.class);
                            startActivity(i);
                            finish();
                            progressBar.setVisibility(View.INVISIBLE);
                            Toast.makeText(sign_up.this,"Sign In Is Successful ",Toast.LENGTH_LONG).show();
                        }
                        else {
                            Toast.makeText(sign_up.this,"Sign In Is Not Successful ",Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
