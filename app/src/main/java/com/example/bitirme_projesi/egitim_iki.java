...
public class egitim_iki extends AppCompatActivity {
    ...
    DatabaseReference databaseReference= database.getReference().child("questions").child("Deneme 2");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendScore();
                Intent i = new Intent(egitim_iki.this, egitimler.class);
                startActivity(i);
                finish();
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(questionNumber < questionCount) {
                    ...
                    Toast.makeText(egitim_iki.this, "You answered all questions", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Toast.makeText(egitim_iki.this, "Failed to read value. Check log for details.", Toast.LENGTH_LONG).show();
                Toast.makeText(egitim_iki.this, "Sorry, there is a problem!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void sendScore() {
        ...
        // Eğitim iki için doğru ve yanlış cevapları kaydet
        DatabaseReference egitimIkiRef = userRef.child("egitim_iki");
        egitimIkiRef.child("correct").setValue(userCorrect);
        egitimIkiRef.child("wrong").setValue(userWrong);
    }
}
