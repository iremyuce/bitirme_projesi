...
public class egitim_uc extends AppCompatActivity {
    ...
    DatabaseReference databaseReference= database.getReference().child("questions").child("Deneme 3");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendScore();
                Intent i = new Intent(egitim_uc.this, egitimler.class);
                startActivity(i);
                finish();
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(questionNumber < questionCount) {
                    ...
                    Toast.makeText(egitim_uc.this, "You answered all questions", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Toast.makeText(egitim_uc.this, "Failed to read value. Check log for details.", Toast.LENGTH_LONG).show();
                Toast.makeText(egitim_uc.this, "Sorry, there is a problem!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void sendScore() {
        ...
        DatabaseReference egitimUcRef = userRef.child("egitim_uc");
        egitimUcRef.child("correct").setValue(userCorrect);
        egitimUcRef.child("wrong").setValue(userWrong);
    }
}
