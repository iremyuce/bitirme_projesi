...
public class egitim_dort extends AppCompatActivity {
    ...
    DatabaseReference databaseReference= database.getReference().child("questions").child("Deneme 4");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendScore();
                Intent i = new Intent(egitim_dort.this, egitimler.class);
                startActivity(i);
                finish();
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(questionNumber < questionCount) {
                    ...
                    Toast.makeText(egitim_dort.this, "You answered all questions", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Toast.makeText(egitim_dort.this, "Failed to read value. Check log for details.", Toast.LENGTH_LONG).show();
                Toast.makeText(egitim_dort.this, "Sorry, there is a problem!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void sendScore() {
        ...
        DatabaseReference egitimDortRef = userRef.child("egitim_dort");
        egitimDortRef.child("correct").setValue(userCorrect);
        egitimDortRef.child("wrong").setValue(userWrong);
    }
}
